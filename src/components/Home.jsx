        ...
        <div className="flex items-center justify-between py-2">
          ...
          <div className="flex text-white">
            <div className="flex justify-center space-x-1 lg:mr-16 pl-1 lg:pl-4 gap-1 lg:gap-3">
              ...
              <a
                href="https://twitter.com/maxzproject"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                href="https://www.linkedin.com/company/maxzio/"
                target="_blank"
                rel="noreferrer"
              >
                <FaLinkedin className="h-6 w-6 text-white -mt-[0.05rem]" />
              </a>
              <a
                href="https://discord.gg/x3sWSqat5A"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="h-full w-full">
        <div className="flex rounded-lg  shadow-lg  w-full h-5/6 p-3 relative">
          <div className="absolute inset-0">
            <img
              className="object-cover w-full lg:w-4/5 h-full "
              src="/bg.png"
          ...
          <div className={`my-auto p-4 sm:p-16  w-full lg:w-3/5 z-10 lg:pl-16`}>
            <p className="text-6xl lg:text-7xl font-bold">
              An Ad Tech Platform for <span className="text-gold">Web 3.0</span>
            </p>
            <p className="mt-6">Start bringing your brands to Metaverse</p>
            <button
              className="bg-yellow-500 text-base text-white font-bold py-2 px-4 lg:w-1/4 mt-4  rounded hover:opacity-80"
              type="submit"
            >
              Read More
            </button>
