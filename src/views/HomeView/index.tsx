        ...
        <div className="h-full w-full bg-black">
                <div className="flex rounded-lg  shadow-lg  w-full h-5/6 p-3 relative">
                    ...
                    <div className={`my-auto p-4 sm:p-16  w-full lg:w-3/5  z-10 lg:pl-16`}>
                        ...
                        <button className="bg-yellow-500 text-base text-white font-bold py-2 px-4 lg:w-1/4 mt-4  rounded hover:opacity-80" type="submit">Sign Up as Merchant</button>
                    </div>
                    {true && <div className="z-10 hidden lg:inline-block">
